  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto">
        ...
        <div className="p-4 md:w-1/3 flex ">
            ...
            <svg fill="none" className='p-2' stroke="currentColor" stroke-linecap="round" strokeLinejoin="round" stroke-width="1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <a
              className="mt-5 group relative inline-flex items-center overflow-hidden rounded bg-main px-8 py-3 text-white focus:outline-none focus:ring active:bg-indigo-500"
              href="/features"
            >
                <span
