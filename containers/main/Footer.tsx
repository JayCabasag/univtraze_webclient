        ...
        <div className="md:grid md:grid-cols-5 md:gap-8">
          <div>
            ...
            <ul role="list" className="mt-4 space-y-4">
              ...
              <li>
                <a href="#" className="text-sm font-normal text-gray-500 hover:text-gray-900"> Test results </a>
              </li>
              <li>
                <a href="#" className="text-sm font-normal text-gray-500 hover:text-gray-900"> Alert notifications </a>
              </li>
            </ul>
          </div>
          ...
          <div className="mt-12 md:mt-0">
            ...
            <ul role="list" className="mt-4 space-y-4">
              ...
              <li>
                <a href="#" className="text-sm font-normal text-gray-500 hover:text-gray-900"> Email : test@email.com </a>
              </li>
            </ul>
          </div>
          <div className="mt-12 md:mt-0">
          ...
          <div className="mt-12 md:mt-0">
            ...
            <ul role="list" className="mt-4 space-y-4">
              ...
              <li>
                <Link href="/social/signup" className="text-sm font-normal text-gray-500 hover:text-gray-900"> Sign up </Link>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="px-5 py-12 mx-auto bg-gray-50 max-w-7xl sm:px-6 md:flex md:items-center md:justify-between lg:px-20">
        ...
        <div className="mt-8 md:mt-0 md:order-1">
          <span className="mt-2 text-sm font-light text-gray-500">
            Copyright © 2022 - 2023
            <a href="#" className="mx-2 text-wickedblue hover:text-gray-500" rel="noopener noreferrer">@univtraze</a>. Since 2022
          </span>
        </div>
      </div>
    </footer>
