...
export default function VerifyAccountContainer() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if(roleValue === UserTypes.EMPLOYEE && professorDepartment === ''){
      return setEncounteredError('Add your faculty/Department')
    }
    if(roleValue === UserTypes.EMPLOYEE && professorEmployeeId === ''){
    ...
    if(roleValue === UserTypes.EMPLOYEE){
      setUserDetails(prevState => {
        return {
          ...prevState,
          firstname,
                    ...
                    <div className="mb-4">
                      <label className="block text-slate-500 font-bold mb-2 text-sm" htmlFor="frontId">
                        Front ID (
                          ...
                          {roleValue === UserTypes.EMPLOYEE && ('Employee ID')}
